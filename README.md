...
* **Mejor Desempeño:** El modelo basado en **Vision Transformer** demostró ser el más robusto, alcanzando la métrica más alta en todas las categorías (>96%), consolidándose como la mejor opción para este dataset.
